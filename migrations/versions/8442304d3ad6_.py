...
Revision ID: 8442304d3ad6
Revises: 4169dd7a0e6b
Create Date: 2017-10-04 21:09:26.792006
...
revision = '8442304d3ad6'
down_revision = '4169dd7a0e6b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('article_series_id', sa.Integer(), nullable=True),
    sa.Column('category_id', sa.Integer(), nullable=True),
