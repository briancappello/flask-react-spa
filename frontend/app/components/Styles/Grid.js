...
<div class="row">
    <div class="two cols fixed" style="background-color: red;">fixed</div>
    <div class="ten cols offset-by-two">foo</div>
</div>
<div class="row">
    <div class="two cols">two cols</div>
...
`
    ...
    fractions = {
        title: 'Fractions',
        description: 'Columns should be wrapped by <code>.row</code> and any combination adding up to <strong><u>one</u></strong> will work (eg <sup>1</sup>/<sub>4</sub> + <sup>3</sup>/<sub>4</sub>, <sup>1</sup>/<sub>4</sub> + <sup>1</sup>/<sub>2</sub> + <sup>1</sup>/<sub>4</sub>, <sup>2</sup>/<sub>3</sub> + <sup>1</sup>/<sub>3</sub>, etc)',
        html: [
`<div class="row">
...
`,
    ...
    columnOffsets = {
        ...
        description: 'Offset classes should be added to the first column in a row to push the columns to the right. The total of offset plus columns should equal <strong><u>twelve</u></strong>.',
        html: [
`<div class="row">
...
`,
`<div class="row"> <div class="eleven cols offset-by-one">eleven cols offset-by-one</div> </div>
<div class="row"> <div class="ten cols offset-by-two">ten cols offset-by-two</div> </div>
<div class="row"> <div class="nine cols offset-by-three">nine cols offset-by-three</div> </div>
<div class="row"> <div class="eight cols offset-by-four">eight cols offset-by-four</div> </div>
<div class="row"> <div class="seven cols offset-by-five">seven cols offset-by-five</div> </div>
<div class="row"> <div class="six cols offset-by-six">six cols offset-by-six</div> </div>
<div class="row"> <div class="five cols offset-by-seven">five cols offset-by-seven</div> </div>
<div class="row"> <div class="four cols offset-by-eight">four cols offset-by-eight</div> </div>
<div class="row"> <div class="three cols offset-by-nine">three cols offset-by-nine</div> </div>
<div class="row"> <div class="two cols offset-by-ten">two cols offset-by-ten</div> </div>
<div class="row"> <div class="one col offset-by-eleven">one col offset-by-eleven</div> </div>
`,
    ]}
